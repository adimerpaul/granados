...
@section('content')
    ...
    <section class="show-internal-requirements">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <a class="btn btn-outline-secondary" href="{{route('works.warehouses.internalRequirements.index', ['work' => Auth::user()->work->id])}}">
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                              @foreach ($internalRequirement->internalRequiredProducts as $internalRequiredProduct)
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        <form action="{{route('works.warehouses.internalRequirements.internalRequiredProduct.productDispatch', ['work' => Auth::user()->work->id, 'internalRequiredProduct' => $internalRequiredProduct->id] )}}" method="POST">
                                            ...
                                            <input class="btn btn-success" type="submit" value="Despachar" {{($internalRequiredProduct->status == 'Despachado') ? 'disabled' : ''}}>
                                        </form>
                                    </td>
                                </tr>                                  
                              @endforeach
