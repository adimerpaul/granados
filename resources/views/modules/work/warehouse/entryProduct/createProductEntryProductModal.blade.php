...
<form action="{{route('works.requirements.products.create', ['work' => Auth::user()->work_id])}}" method="POST">
    ...
    <div class="modal fade" id="createProductModalEntryProduct" tabindex="-1" aria-labelledby="createProductModalEntryProductLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createProductModalEntryProductLabel">Campos del Producto</h5>
